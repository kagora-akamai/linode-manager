...
export const DestinationCustomHttpsDetailsForm = (
  ...
  const pendoIds = {
    [authenticationType.Basic]: `${pendoPageId}Authentication Basic`,
    [authenticationType.None]: `${pendoPageId}Authentication None`,
    [contentType.Json]: `${pendoPageId}Json`,
    [contentType.JsonUtf8]: `${pendoPageId}Json Utf8`,
  };
        ...
        render={({ field, fieldState }) => (
          <Autocomplete
            ...
            textFieldProps={{
              ...
              inputProps: {
                'data-pendo-id': `${pendoPageId}Authentication Type`,
              },
            }}
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <TextField
                ...
                errorText={fieldState.error?.message}
                inputProps={{
                  'data-pendo-id': `${pendoPageId}Username`,
                }}
                label="Username"
                onBlur={field.onBlur}
                onChange={(value) => {
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <HideShowText
                ...
                errorText={fieldState.error?.message}
                inputProps={{
                  'data-pendo-id': `${pendoPageId}Password`,
                }}
                label="Password"
                onBlur={field.onBlur}
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <TextField
            ...
            errorText={fieldState.error?.message}
            inputProps={{
              'data-pendo-id': `${pendoPageId}Endpoint URL`,
            }}
            label="Endpoint URL"
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <TextField
            errorText={fieldState.error?.message}
            inputProps={{
              'data-pendo-id': `${pendoPageId}TLS Hostname`,
            }}
            label="TLS Hostname"
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <TextField
            errorText={fieldState.error?.message}
            inputProps={{
              'data-pendo-id': `${pendoPageId}Client Ca Certificate`,
            }}
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <TextField
            errorText={fieldState.error?.message}
            inputProps={{
              'data-pendo-id': `${pendoPageId}Client Certificate`,
            }}
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <TextField
            errorText={fieldState.error?.message}
            inputProps={{
              'data-pendo-id': `${pendoPageId}Private Key`,
            }}
        ...
        render={({ field, fieldState }) => (
          <Autocomplete
            ...
            textFieldProps={{
              ...
              inputProps: {
                'data-pendo-id': `${pendoPageId}Content Type`,
              },
            }}
