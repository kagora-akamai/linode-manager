        ...
        <>
          ...
          <div hidden={true}>
            <Controller
              ...
              render={({ field }) => (
                <Checkbox
                  checked={field.value}
                  data-pendo-id={`${pendoIdPrefix}Clusters-Include All`}
          ...
          >
            <DebouncedSearchTextField
              ...
              hideLabel
              inputProps={{
                'data-pendo-id': `${pendoIdPrefix}Clusters-Search`,
              }}
              label="Search"
